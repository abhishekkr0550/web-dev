"use strict";
eesy.define(['jquery-private', 'context-probe', 'context-handling', 'json!context-node-link-data',
    'monitor-handling', 'monitor-lti-launch-handling',
    ...
    function start() {
        ...
        else if (window['Impact'] && window['Impact'].init) {
