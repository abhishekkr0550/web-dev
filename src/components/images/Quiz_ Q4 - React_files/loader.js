...
function eesy_init_require() {
    ...
    eesyRequire( ['jquery-private', 'sessionInfo', 'engine_core'], function($, sessionInfo, engineCore) {
        ...
        eesy_load_css(getCssUrl(var_dashboard_url, '/resources/style_v2/eesysoft-template/assets/css/supportCenter.min.css'));
        eesy_load_css(getCssUrl(var_style_path, '/override-proactive.css'));
        eesy_load_css(getCssUrl(var_dashboard_url, '/static/css/support-center-theme-defaults.min.css'));
        ...
        eesy_initUserValues(function() {
            var eesy_url_load_templates = var_dashboard_url + "/rest/public/proactive/templates"
    ...
    function __eesyRequire(sessionKey, build, dbUpdateCount) {
        var staticJsLocation = (sessionStorage.DBG_LOCAL_STATIC_JS ? "http://127.0.0.1:9666/" : "") + 'static/js';
